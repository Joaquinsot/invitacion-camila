...
const guestsDatabase = [
  ...
  { id: 72, code: "1072", name: "Sugey", adults: 1, kids: 0 },
  { id: 73, code: "1073", name: "Emmanuel", adults: 1, kids: 0 },
  ...
  { id: 80, code: "1080", name: "Ximena 1", adults: 1, kids: 0 },
  { id: 81, name: "Blanca", adults: 1, kids: 0 },
